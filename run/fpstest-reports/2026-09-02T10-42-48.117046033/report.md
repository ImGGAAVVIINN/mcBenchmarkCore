# FPS Test session — 2026-09-02T10:43:59.328382979+10:00
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|
| 1 | [Base FPS + PBR pack + highEnd shader](#base-fps--pbr-pack--highend-shader) | Showcase | 0.0 | 0.0 | 0.0 | 0.00 | 0.00 | 0 | 0 |

## Details

### Base FPS + PBR pack + highEnd shader (`pack_shader_base_fps`)

Category: **Showcase**  |  Duration: 67862 ms  |  Sample ticks: 0
